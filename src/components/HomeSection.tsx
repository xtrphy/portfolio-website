    ...
    return (
        <>
            <section
                ...
                ref={ref}
            >
                <div className='ml-[120px] flex flex-col gap-5 text-7xl'>
                    <h1 className='relative italic font-black'>
                        владислав перепечкин.
                        <motion.div
                            style={{ y }}
                        >
                            <Badge className='absolute bottom-7 -right-25 -rotate-2 text-lg bg-white/10 backdrop-blur-md text-[#444] border border-white/30 shadow-md px-4 py-1 rounded-xl ring-1 ring-white/20 hover:-rotate-3 hover:scale-103 hover:ring-black transition-all duration-200'>
                    ...
                    <ul className='flex flex-col gap-2 text-[#444] text-2xl tracking-wide list-none'>
                        <li className='flex items-center gap-3'><CircleCheck color='green' strokeWidth={3} />креативный и внимательный к деталям.</li>
                        <li className='flex items-center gap-3'><CircleCheck color='green' strokeWidth={3} />делаю так, что хочется возвращаться</li>
                        <li className='flex items-center gap-3'><CircleCheck color='green' strokeWidth={3} />цель номер один: уникальность и функционал</li>
                    </ul>
